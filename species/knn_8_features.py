...
probs = knn.predict_proba(species_features_test)
...
with open('data_knn_8f.txt', 'w') as f:
...
for data in datasets:
    ...
    print('F-score: ' + np.array2string(top_5_f1))
    print('F-score mean: ' + str(np.mean(top_5_f1)))
    print('Kappa: ' + np.array2string(top_5_k))
    print('Kappa mean: ' + str(np.mean(top_5_k)))
    print('\n')

    with open('data_knn_8f.txt', 'a') as f:
        f.write(str(names[j])+'\n')
        ...
        f.write('F-score: ' + np.array2string(top_5_f1)+'\n')
        f.write('F-score mean: ' + str(np.mean(top_5_f1))+'\n')
